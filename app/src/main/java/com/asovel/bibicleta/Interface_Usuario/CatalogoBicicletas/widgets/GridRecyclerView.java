package com.asovel.bibicleta.Interface_Usuario.CatalogoBicicletas.widgets;

/**
 * Created by emilio on 24/09/2016.
 */
...
public class GridRecyclerView extends RecyclerView {
    ...
    public void setLayoutManager(LayoutManager layout) {
        if (layout instanceof GridLayoutManager) {
            ...
            throw new ClassCastException("Sólo se debe utilizar un GridLayoutManager con GridRecyclerView.");
        }
    }
